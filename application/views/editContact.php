...
<?= form_open("employee/updateContact/{$records->user_id}") ?>
...
<?php if(isset($record->avatar)) :?>
      <img src="<?php echo base_url()?>/assets/image/blank.png" alt="" style="width:230px; height:230px;"/>
         <?php else :?>
     <img src="<?= $records->avatar ;?>" alt="" style="width:230px; height:230px;"/>
      </a>
      <?php endif ?>
...
<ul class="nav nav-pills nav-stacked"> 
      <li class="active"><a href='<?= base_url("employee/empPersonalDetail/{$records->user_id}") ?>'>Personal Details</a></li>
      <li class="nav-item active">
      <a class="nav-link" href='<?= base_url("employee/empContactDetail/{$records->user_id}") ?>'>Contact Details</a>
      </li>
      <li class="nav-item active">
      <a class="nav-link" href='<?= base_url("employee/empQualificationDetail/{$records->user_id}") ?>'> Qualification Details</a>
      </li>
  </ul>
</div>
...
<div class="row">
    <div class="col-lg-9">
       ...
       <label for="inputEmail" class="col-lg-3 control-label">State</label>
           <div class="col-lg-7">
           <?php if(empty($contact)){ ?>
            <?= form_input(['name'=>'state','class'=>'form-control','placeholder'=>'state Name','value'=> set_value('state')]) ?>
<?php }else{ ?>
